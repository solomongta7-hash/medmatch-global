...
(function () {
  ...
  var T3 = {
    ...
    fr: {
      ...
      "t5.title": "Au-delà des quatre — un hôpital complet", "t5.desc": "Chirurgie esthétique, chirurgie oculaire iLASIK & SMILE, ballon et sleeve gastriques, bilans de santé et imagerie avancée — réalisés chez notre groupe hospitalier partenaire, l'un des plus grands de Turquie, aux tarifs officiels payés directement à l'hôpital.", "t5.unit": "grille tarifaire de l'hôpital", "t5.save": "60+ INTERVENTIONS, TARIFS ÉCRITS", "t5.includes": "Hôtel inclus uniquement lorsque indiqué — nos frais fixes de 300 $ sont la seule chose que vous nous payez.", "t5.cta": "Voir toute la grille tarifaire"
    },
    ru: {
      ...
      "t5.title": "За пределами четырёх — полноценная больница", "t5.desc": "Пластическая хирургия, лазерная коррекция iLASIK и SMILE, желудочный баллон и рукавная резекция, чек-апы и современная диагностика — в нашей партнёрской больничной группе, одной из крупнейших в Турции, по официальным ценам, оплачиваемым напрямую больнице.", "t5.unit": "прайс-лист больницы", "t5.save": "60+ ПРОЦЕДУР, ЦЕНЫ ПИСЬМЕННО", "t5.includes": "Отель включён только там, где указано — наш фиксированный сбор $300 — единственное, что вы платите нам.", "t5.cta": "Смотреть полный прайс-лист"
    },
    zh: {
      ...
      "t5.title": "四项之外 — 综合医院保障", "t5.desc": "整形外科、iLASIK 与 SMILE 眼科手术、胃球囊与胃缩小、高端体检与先进影像——在我们的合作医院集团（土耳其最大之一）完成，以直接支付给医院的官方价格。", "t5.unit": "医院价目表", "t5.save": "60+ 项目，明码标价", "t5.includes": "仅在注明处含酒店——您付给我们的只有固定的 300 美元费用。", "t5.cta": "查看完整价目表"
    },
    fa: {
    ...
    hi: {
      ...
      "t5.title": "इन चार से आगे — पूर्ण अस्पताल देखभाल", "t5.desc": "प्लास्टिक सर्जरी, iLASIK और SMILE नेत्र सर्जरी, गैस्ट्रिक स्लीव और बैलून, एग्ज़ीक्यूटिव चेक-अप और उन्नत इमेजिंग — हमारे साझेदार अस्पताल समूह में, जो तुर्की के सबसे बड़े समूहों में से एक है, सीधे अस्पताल को भुगतान की जाने वाली आधिकारिक कीमतों पर।", "t5.unit": "अस्पताल मूल्य सूची", "t5.save": "60+ प्रक्रियाएँ, लिखित मूल्य", "t5.includes": "होटल केवल वहीं शामिल जहाँ बताया गया है — हमें आप केवल निश्चित $300 शुल्क चुकाते हैं।", "t5.cta": "पूरी मूल्य सूची देखें"
    }
  };
